...
describe('ReactElement', () => {
  ...
  it('allows static methods to be called using the type property', () => {
    ...
    StaticMethodComponent.someStaticMethod = () =>
      'someReturnValue'

    const element = React.createElement(
      StaticMethodComponent
    )
    expect(element.type.someStaticMethod()).toBe(
      'someReturnValue'
    )
  })
  ...
  it('identifies valid elements', () => {
    ...
    expect(
      React.isValidElement(React.createElement('div'))
    ).toEqual(true)
    expect(
      React.isValidElement(React.createElement(Component))
    ).toEqual(true)
    ...
    expect(
      React.isValidElement({ type: 'div', props: {} })
    ).toEqual(false)
    ...
    expect(
      React.isValidElement(JSON.parse(jsonElement))
    ).toBe(true)
  })
